...
export class Camera {
  ...
  update(): void {
    ...
    const rightBoundValue =
      Constants.worldBoundary.maxX + cameraPadding - app.screen.width
    const topBoundValue = Constants.worldBoundary.minY - cameraPadding
    const bottomBoundValue =
      Constants.worldBoundary.maxY + cameraPadding - app.screen.height
